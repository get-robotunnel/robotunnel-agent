...
fn main() {
    ...
    let build_date = env::var("ROBOTUNNEL_BUILD_DATE").unwrap_or_else(|_| String::from("unknown"));
    let git_commit = env::var("ROBOTUNNEL_GIT_COMMIT").unwrap_or_else(|_| String::from("unknown"));
